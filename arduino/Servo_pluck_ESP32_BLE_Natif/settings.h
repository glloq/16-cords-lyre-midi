/***********************************************************************************************
----------------------------         SETTINGS ESP32 BLE     ------------------------------------
Fichier de configuration pour ESP32 avec Bluetooth Low Energy MIDI

DIFFERENCES avec la version Arduino Leonardo:
- Pins adaptes pour ESP32 (GPIO)
- Support BLE MIDI au lieu de MIDIUSB
- Pins I2C par defaut ESP32: SDA=21, SCL=22
************************************************************************************************/
#ifndef SETTINGS_H
#define SETTINGS_H
...
#define PIN_SERVO_OE 5  // Pin GPIO pour controler OE du PCA9685 (LOW=actif, HIGH=inactif)

// Configuration I2C pour ESP32 (optionnel - par defaut SDA=21, SCL=22)
// Decommentez pour utiliser des pins personnalises:
// #define I2C_SDA 21
// #define I2C_SCL 22
